        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoConviteExpiracao = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TipoExpiracaoEConvite = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FotoCapaUrl = table.Column<string>(type: "text", nullable: true),
                    GrupoId = table.Column<Guid>(type: "uuid", nullable: false),
                    Discriminator = table.Column<string>(type: "character varying(21)", maxLength: 21, nullable: false),
                    Valor = table.Column<double>(type: "double precision", nullable: true),
                    DataSorteio = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ResultadoSorteio = table.Column<string>(type: "text", nullable: true),
                    Sorteado = table.Column<bool>(type: "boolean", nullable: true),
                    NomeAniversariante = table.Column<string>(type: "text", nullable: true),
                    Idade = table.Column<int>(type: "integer", nullable: true),
                    ListaDesejosId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservadoPorId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
